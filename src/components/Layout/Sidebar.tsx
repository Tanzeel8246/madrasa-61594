...
import { BookOpen, Users, GraduationCap, ClipboardCheck, LayoutDashboard, BookMarked, FileText, DollarSign, Shield, X, Menu, BarChart3, Wallet } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navigation = [
    ...
    ...(isAdmin ? [{ name: t('expenses.title'), href: "/expenses", icon: Wallet }] : []),
