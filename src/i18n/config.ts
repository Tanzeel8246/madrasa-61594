  ...
  en: {
    translation: {
      ...
      reports: {
        ...
        deleteConfirmDescription: 'Are you sure you want to delete this report? This action cannot be undone.',
      },
      expenses: {
        title: 'Income & Expenses',
        description: 'Manage income and expenses for your madrasa',
        addTransaction: 'Add Transaction',
        editTransaction: 'Edit Transaction',
        transactions: 'Recent Transactions',
        searchPlaceholder: 'Search by title or category...',
        noTransactions: 'No transactions found',
        noTransactionsFound: 'No matching transactions',
        type: 'Type',
        income: 'Income',
        expense: 'Expense',
        category: 'Category',
  ...
  ur: {
    translation: {
      ...
      reports: {
        ...
        attendanceReports: 'حاضری کی رپورٹس',
        feeReports: 'فیس کی رپورٹس',
        ...
        generatePDF: 'پی ڈی ایف رپورٹ بنائیں',
        noReportsFound: 'آپ کے معیار سے مماثل کوئی رپورٹ نہیں ملی',
        deleteConfirmTitle: 'رپورٹ حذف کریں',
        deleteConfirmDescription: 'کیا آپ واقعی اس رپورٹ کو حذف کرنا چاہتے ہیں؟ یہ عمل واپس نہیں کیا جا سکتا۔',
      },
      expenses: {
        title: 'آمدن اور خرچ',
        description: 'اپنے مدرسے کی آمدن اور خرچ کا انتظام کریں',
        addTransaction: 'لین دین شامل کریں',
        editTransaction: 'لین دین میں ترمیم کریں',
        transactions: 'حالیہ لین دین',
        searchPlaceholder: 'عنوان یا زمرہ سے تلاش کریں...',
        noTransactions: 'کوئی لین دین نہیں ملا',
        noTransactionsFound: 'کوئی مماثل لین دین نہیں',
        type: 'قسم',
        income: 'آمدن',
        expense: 'خرچ',
        category: 'زمرہ',
